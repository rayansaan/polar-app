...
// ===== CONFIGURATION =====
const CONFIG = {
  TMDB_API_KEY: process.env.TMDB_API_KEY || '106f51e20c9abaeec709f99ad73c7991',
  SUPABASE_URL: process.env.SUPABASE_URL || 'https://pqyqdvpncpohelzdfdop.supabase.co',
...
if (!CONFIG.SUPABASE_SERVICE_KEY) {
  ...
  console.log('');
  console.log('💡 Créez un fichier .env dans ce dossier avec:');
  console.log('   SUPABASE_SERVICE_ROLE_KEY=votre_clé_ici');
  console.log('');
  console.log('📄 Ou copiez .env.example en .env et remplissez-le');
  process.exit(1);
}
...
async function checkTables() {
  ...
  try {
    ...
    if (error && error.code === '42P01') {
      ...
      console.log('⚠️  Exécutez d\'abord le SQL de création dans Supabase');
      process.exit(1);
    }
